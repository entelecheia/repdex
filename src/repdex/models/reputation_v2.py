...
class LawsuitDetails(BaseModelV2):
    has_reputation: bool = Field(description="Indicates if the text mentions a reputation")
    claimant: List[str] = Field(description="The claimant in the reputation")
    defendant: List[str] = Field(description="The defendant in the reputation")
    case_summary: str = Field(description="A brief summary of the case")
    case_date: str = Field(description="The date of the reputation")
